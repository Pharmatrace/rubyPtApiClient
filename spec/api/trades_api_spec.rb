...
describe 'TradesApi' do
  before do
    ...
    @instance = OpenapiClient::TradesApi.new
  end
  ...
  describe 'test an instance of TradesApi' do
    it 'should create an instance of TradesApi' do
      expect(@instance).to be_instance_of(OpenapiClient::TradesApi)
    end
  end

  # unit tests for add_trade
  # Creates a new trade
  # @param trade Trade to create
  # @param [Hash] opts the optional parameters
  # @return [Trade]
  describe 'add_trade test' do
    it 'should work' do
  ...
  # unit tests for find_trade_by_id
  # Returns a trade based on the ID
  # @param id ID of trade to fetch
  # @param [Hash] opts the optional parameters
  # @return [Trade]
  describe 'find_trade_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for find_trades
