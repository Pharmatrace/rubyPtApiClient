...
# Unit tests for OpenapiClient::ProfilesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProfilesApi' do
  before do
    # run before each test
    @instance = OpenapiClient::ProfilesApi.new
  end
  ...
  describe 'test an instance of ProfilesApi' do
    it 'should create an instance of ProfilesApi' do
      expect(@instance).to be_instance_of(OpenapiClient::ProfilesApi)
    end
  end
  ...
  # unit tests for find_profile_by_id
  # Returns a profile based on the ID
  # @param id ID of profile to fetch
  # @param [Hash] opts the optional parameters
  # @return [Profile]
  describe 'find_profile_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for find_profiles
  ...
  describe 'find_profiles test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
