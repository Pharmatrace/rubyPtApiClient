...
# Unit tests for OpenapiClient::ContainersApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContainersApi' do
  before do
    # run before each test
    @instance = OpenapiClient::ContainersApi.new
  end
  ...
  describe 'test an instance of ContainersApi' do
    it 'should create an instance of ContainersApi' do
      expect(@instance).to be_instance_of(OpenapiClient::ContainersApi)
    end
  end

  # unit tests for add_container
  # Creates a new container
  # @param container Container to create
  # @param [Hash] opts the optional parameters
  # @return [Container]
  describe 'add_container test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_container
  # deletes a single container based on the ID supplied
  # @param id ID of container to delete
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_container test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for find_container_by_id
  # Returns a container based on the ID
  # @param id ID of container to fetch
  # @param [Hash] opts the optional parameters
  # @return [Container]
  describe 'find_container_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for find_containers
  ...
  describe 'find_containers test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
