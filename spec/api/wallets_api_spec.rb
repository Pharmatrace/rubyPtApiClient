...
describe 'WalletsApi' do
  before do
    ...
    @instance = OpenapiClient::WalletsApi.new
  end
  ...
  describe 'test an instance of WalletsApi' do
    it 'should create an instance of WalletsApi' do
      expect(@instance).to be_instance_of(OpenapiClient::WalletsApi)
    end
  end
  ...
  # unit tests for find_wallet_by_id
  # Returns a wallet based on the ID
  # @param id ID of wallet to fetch
  # @param [Hash] opts the optional parameters
  # @return [Wallet]
  describe 'find_wallet_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for find_wallets
