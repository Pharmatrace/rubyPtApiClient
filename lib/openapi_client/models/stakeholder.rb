...
module OpenapiClient
  class Stakeholder
    ...
    attr_accessor :stakeholder_role
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'trade_id')
        self.trade_id = attributes[:'trade_id']
      end

      if attributes.has_key?(:'trade_id_type')
        self.trade_id_type = attributes[:'trade_id_type']
      end
      ...
      if attributes.has_key?(:'stakeholder_role')
        self.stakeholder_role = attributes[:'stakeholder_role']
      end
    ...
    def hash
      [trade_id, trade_id_type, display_name, stakeholder_role, wallet_id].hash
    end
