...
module OpenapiClient
  class InformationQueryResponse
    # GMT, Unix Epoch
    attr_accessor :timestamp

    # unique id hash of the transaction
    attr_accessor :tx_uid
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tx_uid')
        self.tx_uid = attributes[:'tx_uid']
      end
      ...
      if attributes.has_key?(:'transaction_channel')
    ...
    def hash
      [timestamp, tx_uid, terms_id, transaction_channel].hash
    end
