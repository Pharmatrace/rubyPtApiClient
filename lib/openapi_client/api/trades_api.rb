...
module OpenapiClient
  class TradesApi
    ...
    # @return [Trade]
    def add_trade(trade, opts = {})
      data, _status_code, _headers = add_trade_with_http_info(trade, opts)
      data
    end
    ...
    def add_trade_with_http_info(trade, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradesApi.add_trade ...'
      end
      # verify the required parameter 'trade' is set
      if @api_client.config.client_side_validation && trade.nil?
        fail ArgumentError, "Missing the required parameter 'trade' when calling TradesApi.add_trade"
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(trade)
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Trade')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradesApi#add_trade\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_trade_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradesApi.delete_trade ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TradesApi.delete_trade"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradesApi#delete_trade\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Trade]
    def find_trade_by_id(id, opts = {})
      data, _status_code, _headers = find_trade_by_id_with_http_info(id, opts)
      data
    end
    ...
    # @return [Array<Trade>]
    def find_trades(opts = {})
      data, _status_code, _headers = find_trades_with_http_info(opts)
      data
    end
    ...
    def find_trades_with_http_info(opts = {})
      if @api_client.config.debugging
